...
import com.example.NewFileServlet.Folder;
...
public class NewFileServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (idSopracartella != null) {
			createFileIntoDB(user, nome, Date.valueOf(LocalDate.now()), sommario, tipo, idSopracartella);
	...
	private void createFileIntoDB(String proprietario, String nome, Date data_creazione, String sommario, String tipo,
			Integer sopracartella) {
		final String JDBC_URL = "jdbc:mysql://localhost:3306/tiw_project?serverTimezone=UTC";
		final String JDBC_USER = "root";
		final String JDBC_PASSWORD = "iononsonotu";
