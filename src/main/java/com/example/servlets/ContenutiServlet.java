...
//Lista di elementi in una cartella qualsiasi (di root o sottocartella)
...
public class ContenutiServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (folderTokens != null && folderTokens.containsKey(folderToken)) { // se il token corrisponde ad uno
		...
		for (File f : files) { // docs
			...
			out.println("<li class=\"file\">" + f.getNome() + " <a href=\"AccediServlet?fileToken=" + token
