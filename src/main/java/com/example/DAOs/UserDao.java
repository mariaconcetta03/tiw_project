...
public class UserDao {
	...
	Connection connection = null; // Questa è la connessione col DB

	// Questo metodo si connette con il DB
	...
	// Questo metodo controlla le credenziali di un utente durante il LOGIN
	...
	public List<Integer> insertUser(String user, String pass, String em) {
		...
		/**
		 * Questo array ci serve per ritornare errori: - il primo elemento indica se lo
		 * username è unique o no - il secondo elemento indica se c'è un Connection
		 * Error oppure no
		 **/
